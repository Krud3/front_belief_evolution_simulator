...
import logoPromueva from '@/assets/images/logos/promueva.svg'
import logoAvispa from '@/assets/images/logos/avispa.svg'
import logoUnivalle from '@/assets/images/logos/univalle.svg'
  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        <Button href="/register">lorem ipsum</Button>
        <Button
